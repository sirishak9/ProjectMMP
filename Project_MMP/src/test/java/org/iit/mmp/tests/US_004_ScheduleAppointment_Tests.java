...
public class US_004_ScheduleAppointment_Tests {
	...
	public boolean validateApptDetailsinHomePage(HashMap<String, String> hMap)
	{
	...
	public boolean validateApptDetailsinScheduleApptPage(HashMap<String, String> hMap)
	{
		boolean result = false;
